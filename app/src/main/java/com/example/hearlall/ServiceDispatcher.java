...
import com.example.hearlall.messages.AudioSessionEvent;
...
public class ServiceDispatcher extends BroadcastReceiver {
    ...
    public static void startService(Context context) {
        Intent service = new Intent(context.getApplicationContext(), com.example.hearlall.VolumeBoostService.class);
