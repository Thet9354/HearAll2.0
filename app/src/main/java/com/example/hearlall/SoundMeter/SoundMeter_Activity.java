package com.example.hearlall.SoundMeter;
...
public class SoundMeter_Activity extends AppCompatActivity {
    ...
    private void pageDirectories() {
        infoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                InfoDialog.Builder builder = new InfoDialog.Builder(SoundMeter_Activity.this);
